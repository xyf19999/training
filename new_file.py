...
def extract_first_column(file_path):
    ...
    print(len(result))
    return result
included_image_val = extract_first_column('/home/yifei/monitizer/monitizer/benchmark_object_detection/specifications/bdd_day_no_bus/generated_OOD_region_val.txt')
...
with open(f'/home/yifei/bdd_day_no_bus/bdd_daytime_no_bus_val.json', 'r') as input_file:
...
source_folder = '/home/yifei/bdd_day_no_bus/val2017'
destination_path = '/home/yifei/bdd_day_no_bus/val_for_optimization'
