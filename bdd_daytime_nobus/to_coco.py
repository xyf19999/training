...
def parse_arguments():
    ...
    parser.add_argument(
          "-l", "--label_dir",
          default="/home/yifei/bdd_daytime_no_bus",
          help="root directory of BDD label Json files",
    )
    parser.add_argument(
          "-s", "--save_path",
          default="/home/yifei/bdd_daytime_no_bus/annotations",
...
if __name__ == '__main__':
    ...
    with open(os.path.join(args.label_dir,
                           'bdd_daytime_no_bus_train.json')) as f:
    ...
    with open(os.path.join(args.label_dir,
                           'bdd_daytime_no_bus_val.json')) as f:
